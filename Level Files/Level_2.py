...
def play_level_2():
    ...
    badguy1 = badguy()
    badguy1x = 1808
    badguy1.rect.y = 373  # Floor level -28

    badguy2 = badguy()
    badguy2x = 3104
    badguy2.rect.y = 373  # Floor level -28
    bxcounter = 0

    badguy3 = badguy()
    badguy3x = 4400
    badguy3.rect.y = 373  # Floor level -28
    bxcounter = 0

    badguy4 = badguy()
    badguy4x = 4400
    badguy4.rect.y = 373  # Floor level -28
    bxcounter = 0

    badguy_list = py.sprite.Group()
    badguy_list.add(badguy1, badguy2, badguy3, badguy4)
    ...
    while active:
        ...
        badguy1x = camera_offset_x + bxcounter + 1808
        badguy2x = camera_offset_x + bxcounter + 3104
        badguy3x = camera_offset_x + bxcounter + 4400
        badguy4x = camera_offset_x + bxcounter + 5696
        ...
        draw_terrain(300 + camera_offset_x, 125, 0, 0, "Images/Terrain/Level Entrance/Level 2/Level 2.png", 250, 250)
        ...
        draw_terrain(1480 + camera_offset_x, 510, 0, 0, "Images/Terrain/Ground/Single Grass.png", 128, 128)
        draw_terrain(1480 + camera_offset_x, 638, 0, 2, "Images/Terrain/Ground/Single Ground.png", 128, 128)

        draw_terrain(1808 + camera_offset_x, 473, 0, 0, "Images/Terrain/Ground/Left Grass.png", 128, 128)
        draw_terrain(1808 + camera_offset_x, 601, 0, 2, "Images/Terrain/Ground/Left Middle Ground.png", 128, 128)
        draw_terrain(1936 + camera_offset_x, 473, 3, 0, "Images/Terrain/Ground/Middle Grass.png", 128, 128)
        draw_terrain(1936 + camera_offset_x, 601, 3, 5, "Images/Terrain/Ground/Middle Ground.png", 128, 128)
        draw_terrain(2448 + camera_offset_x, 473, 0, 2, "Images/Terrain/Ground/Right Grass.png", 128, 128)
        draw_terrain(2448 + camera_offset_x, 601, 0, 2, "Images/Terrain/Ground/Middle Right Ground.png", 128, 128)

        spikes(1, 2100 + camera_offset_x, 345, pch3, spike_list).draw(win)

        draw_terrain(2776 + camera_offset_x, 510, 0, 0, "Images/Terrain/Ground/Single Grass.png", 128, 128)
        draw_terrain(2776 + camera_offset_x, 638, 0, 2, "Images/Terrain/Ground/Single Ground.png", 128, 128)

        draw_terrain(3104 + camera_offset_x, 473, 0, 0, "Images/Terrain/Ground/Left Grass.png", 128, 128)
        draw_terrain(3104 + camera_offset_x, 601, 0, 2, "Images/Terrain/Ground/Left Middle Ground.png", 128, 128)
        draw_terrain(3232 + camera_offset_x, 473, 3, 0, "Images/Terrain/Ground/Middle Grass.png", 128, 128)
        draw_terrain(3232 + camera_offset_x, 601, 3, 5, "Images/Terrain/Ground/Middle Ground.png", 128, 128)
        draw_terrain(3744 + camera_offset_x, 473, 0, 2, "Images/Terrain/Ground/Right Grass.png", 128, 128)
        draw_terrain(3744 + camera_offset_x, 601, 0, 2, "Images/Terrain/Ground/Middle Right Ground.png", 128, 128)

        spikes(1, 3400 + camera_offset_x, 345, pch3, spike_list).draw(win)

        draw_terrain(4072 + camera_offset_x, 510, 0, 0, "Images/Terrain/Ground/Single Grass.png", 128, 128)
        draw_terrain(4072 + camera_offset_x, 638, 0, 2, "Images/Terrain/Ground/Single Ground.png", 128, 128)

        draw_terrain(4400 + camera_offset_x, 473, 0, 0, "Images/Terrain/Ground/Left Grass.png", 128, 128)
        draw_terrain(4400 + camera_offset_x, 601, 0, 2, "Images/Terrain/Ground/Left Middle Ground.png", 128, 128)
        draw_terrain(4528 + camera_offset_x, 473, 3, 0, "Images/Terrain/Ground/Middle Grass.png", 128, 128)
        draw_terrain(4528 + camera_offset_x, 601, 3, 5, "Images/Terrain/Ground/Middle Ground.png", 128, 128)
        draw_terrain(5040 + camera_offset_x, 473, 0, 2, "Images/Terrain/Ground/Right Grass.png", 128, 128)
        draw_terrain(5040 + camera_offset_x, 601, 0, 2, "Images/Terrain/Ground/Middle Right Ground.png", 128, 128)

        spikes(1, 4700 + camera_offset_x, 345, pch3, spike_list).draw(win)

        draw_terrain(5368 + camera_offset_x, 510, 0, 0, "Images/Terrain/Ground/Single Grass.png", 128, 128)
        draw_terrain(5368 + camera_offset_x, 638, 0, 2, "Images/Terrain/Ground/Single Ground.png", 128, 128)

        draw_terrain(5696 + camera_offset_x, 473, 0, 0, "Images/Terrain/Ground/Left Grass.png", 128, 128)
        draw_terrain(5696 + camera_offset_x, 601, 0, 2, "Images/Terrain/Ground/Left Middle Ground.png", 128, 128)
        draw_terrain(5824 + camera_offset_x, 473, 3, 0, "Images/Terrain/Ground/Middle Grass.png", 128, 128)
        draw_terrain(5824 + camera_offset_x, 601, 3, 5, "Images/Terrain/Ground/Middle Ground.png", 128, 128)
        draw_terrain(6336 + camera_offset_x, 473, 0, 2, "Images/Terrain/Ground/Right Grass.png", 128, 128)
        draw_terrain(6336 + camera_offset_x, 601, 0, 2, "Images/Terrain/Ground/Middle Right Ground.png", 128, 128)

        draw_terrain(6100 + camera_offset_x, 345, 0, 0, "Images/Terrain/Misc/Finish_Flag.png", 128, 128)
        ...
        if global_player_x_position > 1215 and global_player_x_position < 1460:
            player_y_position += 1
            player_ground_position = 560

        if global_player_x_position >= 1460 and global_player_x_position < 1550:
            player_ground_position = 382

        if global_player_x_position > 1550 and global_player_x_position < 1780:
            player_y_position += 1
            player_ground_position = 560

        if global_player_x_position >= 1780 and global_player_x_position < 2510:
            player_ground_position = 345

        if global_player_x_position > 2510 and global_player_x_position < 2765:
            player_y_position += 1
            player_ground_position = 560

        if global_player_x_position >= 2765 and global_player_x_position < 2835:
            player_ground_position = 382

        if global_player_x_position > 2835 and global_player_x_position < 3085:
            player_y_position += 1
            player_ground_position = 560

        if global_player_x_position >= 3085 and global_player_x_position < 3805:
            player_ground_position = 345

        if global_player_x_position > 3805 and global_player_x_position < 4055:
            player_y_position += 1
            player_ground_position = 560

        if global_player_x_position >= 4055 and global_player_x_position < 4140:
            player_ground_position = 382

        if global_player_x_position > 4140 and global_player_x_position < 4380:
            player_y_position += 1
            player_ground_position = 560

        if global_player_x_position >= 4380 and global_player_x_position < 5105:
            player_ground_position = 345

        if global_player_x_position > 5105 and global_player_x_position < 5350:
            player_y_position += 1
            player_ground_position = 560

        if global_player_x_position >= 5350 and global_player_x_position < 5435:
            player_ground_position = 382

        if global_player_x_position > 5435 and global_player_x_position < 5680:
            player_y_position += 1
            player_ground_position = 560

        if global_player_x_position >= 5680 and global_player_x_position < 6400:
            player_ground_position = 345

        #Determines if player has finished the game, and if true calls game over function
        if global_player_x_position >= 6065:
