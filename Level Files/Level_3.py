...
def play_level_3():
    ...
    while active:
        ...
        # Level Entrance
        draw_terrain(300 + camera_offset_x, 125, 0, 0, "Images/Terrain/Level Entrance/Level 3/Level 3.png", 250, 250)

        #Draws both player graphics with animations
        ...
        draw_terrain(1480 + camera_offset_x, 473, 0, 0, "Images/Terrain/Ground/Single Grass.png", 128, 128)
        draw_terrain(1480 + camera_offset_x, 601, 0, 2, "Images/Terrain/Ground/Single Ground.png", 128, 128)

        draw_terrain(1708 + camera_offset_x, 510, 0, 0, "Images/Terrain/Ground/Single Grass.png", 128, 128)
        draw_terrain(1708 + camera_offset_x, 638, 0, 2, "Images/Terrain/Ground/Single Ground.png", 128, 128)

        draw_terrain(1936 + camera_offset_x, 473, 0, 0, "Images/Terrain/Ground/Single Grass.png", 128, 128)
        draw_terrain(1936 + camera_offset_x, 601, 0, 2, "Images/Terrain/Ground/Single Ground.png", 128, 128)

        spikes(1, 1708 + camera_offset_x, 382, pch3, spike_list).draw(win)

        draw_terrain(2336 + camera_offset_x, 473, 0, 0, "Images/Terrain/Ground/Single Grass.png", 128, 128)
        draw_terrain(2336 + camera_offset_x, 601, 0, 2, "Images/Terrain/Ground/Single Ground.png", 128, 128)

        draw_terrain(2564 + camera_offset_x, 510, 0, 0, "Images/Terrain/Ground/Single Grass.png", 128, 128)
        draw_terrain(2564 + camera_offset_x, 638, 0, 2, "Images/Terrain/Ground/Single Ground.png", 128, 128)

        draw_terrain(2792 + camera_offset_x, 473, 0, 0, "Images/Terrain/Ground/Single Grass.png", 128, 128)
        draw_terrain(2792 + camera_offset_x, 601, 0, 2, "Images/Terrain/Ground/Single Ground.png", 128, 128)

        spikes(1, 2564 + camera_offset_x, 382, pch3, spike_list).draw(win)

        draw_terrain(3192 + camera_offset_x, 473, 0, 0, "Images/Terrain/Ground/Single Grass.png", 128, 128)
        draw_terrain(3192 + camera_offset_x, 601, 0, 2, "Images/Terrain/Ground/Single Ground.png", 128, 128)

        draw_terrain(3420 + camera_offset_x, 510, 0, 0, "Images/Terrain/Ground/Single Grass.png", 128, 128)
        draw_terrain(3420 + camera_offset_x, 638, 0, 2, "Images/Terrain/Ground/Single Ground.png", 128, 128)

        draw_terrain(3648 + camera_offset_x, 473, 0, 0, "Images/Terrain/Ground/Single Grass.png", 128, 128)
        draw_terrain(3648 + camera_offset_x, 601, 0, 2, "Images/Terrain/Ground/Single Ground.png", 128, 128)

        spikes(1, 3420 + camera_offset_x, 382, pch3, spike_list).draw(win)

        draw_terrain(4048 + camera_offset_x, 473, 0, 0, "Images/Terrain/Ground/Single Grass.png", 128, 128)
        draw_terrain(4048 + camera_offset_x, 601, 0, 2, "Images/Terrain/Ground/Single Ground.png", 128, 128)

        draw_terrain(4276 + camera_offset_x, 510, 0, 0, "Images/Terrain/Ground/Single Grass.png", 128, 128)
        draw_terrain(4276 + camera_offset_x, 638, 0, 2, "Images/Terrain/Ground/Single Ground.png", 128, 128)

        draw_terrain(4504 + camera_offset_x, 473, 0, 0, "Images/Terrain/Ground/Single Grass.png", 128, 128)
        draw_terrain(4504 + camera_offset_x, 601, 0, 2, "Images/Terrain/Ground/Single Ground.png", 128, 128)

        spikes(1, 4276 + camera_offset_x, 382, pch3, spike_list).draw(win)

        draw_terrain(4904 + camera_offset_x, 473, 0, 0, "Images/Terrain/Ground/Single Grass.png", 128, 128)
        draw_terrain(4904 + camera_offset_x, 601, 0, 2, "Images/Terrain/Ground/Single Ground.png", 128, 128)

        draw_terrain(5132 + camera_offset_x, 510, 0, 0, "Images/Terrain/Ground/Single Grass.png", 128, 128)
        draw_terrain(5132 + camera_offset_x, 638, 0, 2, "Images/Terrain/Ground/Single Ground.png", 128, 128)

        draw_terrain(5360 + camera_offset_x, 473, 0, 0, "Images/Terrain/Ground/Single Grass.png", 128, 128)
        draw_terrain(5360 + camera_offset_x, 601, 0, 2, "Images/Terrain/Ground/Single Ground.png", 128, 128)

        spikes(1, 5132 + camera_offset_x, 382, pch3, spike_list).draw(win)

        draw_terrain(5760 + camera_offset_x, 473, 0, 0, "Images/Terrain/Ground/Single Grass.png", 128, 128)
        draw_terrain(5760 + camera_offset_x, 601, 0, 2, "Images/Terrain/Ground/Single Ground.png", 128, 128)

        draw_terrain(5988 + camera_offset_x, 510, 0, 0, "Images/Terrain/Ground/Single Grass.png", 128, 128)
        draw_terrain(5988 + camera_offset_x, 638, 0, 2, "Images/Terrain/Ground/Single Ground.png", 128, 128)

        draw_terrain(6216 + camera_offset_x, 473, 0, 0, "Images/Terrain/Ground/Single Grass.png", 128, 128)
        draw_terrain(6216 + camera_offset_x, 601, 0, 2, "Images/Terrain/Ground/Single Ground.png", 128, 128)

        spikes(1, 5988 + camera_offset_x, 382, pch3, spike_list).draw(win)

        draw_terrain(6616 + camera_offset_x, 473, 0, 0, "Images/Terrain/Ground/Single Grass.png", 128, 128)
        draw_terrain(6616 + camera_offset_x, 601, 0, 2, "Images/Terrain/Ground/Single Ground.png", 128, 128)

        draw_terrain(6844 + camera_offset_x, 510, 0, 0, "Images/Terrain/Ground/Single Grass.png", 128, 128)
        draw_terrain(6844 + camera_offset_x, 638, 0, 2, "Images/Terrain/Ground/Single Ground.png", 128, 128)

        draw_terrain(7072 + camera_offset_x, 473, 0, 0, "Images/Terrain/Ground/Single Grass.png", 128, 128)
        draw_terrain(7072 + camera_offset_x, 601, 0, 2, "Images/Terrain/Ground/Single Ground.png", 128, 128)

        spikes(1, 6844 + camera_offset_x, 382, pch3, spike_list).draw(win)

        draw_terrain(7472 + camera_offset_x, 473, 0, 0, "Images/Terrain/Ground/Left Grass.png", 128, 128)
        draw_terrain(7472 + camera_offset_x, 601, 0, 2, "Images/Terrain/Ground/Left Middle Ground.png", 128, 128)
        draw_terrain(7600 + camera_offset_x, 473, 8, 0, "Images/Terrain/Ground/Middle Grass.png", 128, 128)
        draw_terrain(7600 + camera_offset_x, 601, 8, 5, "Images/Terrain/Ground/Middle Ground.png", 128, 128)
        draw_terrain(8752 + camera_offset_x, 473, 0, 2, "Images/Terrain/Ground/Right Grass.png", 128, 128)
        draw_terrain(8752 + camera_offset_x, 601, 0, 2, "Images/Terrain/Ground/Middle Right Ground.png", 128, 128)

        draw_terrain(8550 + camera_offset_x, 345, 0, 0, "Images/Terrain/Misc/Finish_Flag.png", 128, 128)
        ...
        if global_player_x_position < -240:
            player_y_position += 1
            player_ground_position = 560

        #Determinations that calculates if a player is standing on a platform, or in mid-air
        if global_player_x_position <= 1215 and not global_player_x_position < -240:
            player_ground_position = 347

            if player_y_position > 347:
                player_y_position = 347

        if global_player_x_position > 1215 and global_player_x_position < 1470:
            player_y_position += 1
            player_ground_position = 560

        if global_player_x_position >= 1470 and global_player_x_position <= 1545:
            player_ground_position = 347

        if global_player_x_position > 1545 and global_player_x_position < 1920:
            player_y_position += 1
            player_ground_position = 560

        if global_player_x_position <= 1920 and global_player_x_position < 2000:
            player_ground_position = 382

        if global_player_x_position > 2000 and global_player_x_position < 2315:
            player_y_position += 1
            player_ground_position = 560

        if global_player_x_position <= 2315 and global_player_x_position < 2405:
            player_ground_position = 347

        if global_player_x_position > 2405 and global_player_x_position < 2775:
            player_y_position += 1
            player_ground_position = 560

        if global_player_x_position <= 2775 and global_player_x_position < 2855:
            player_ground_position = 347

        if global_player_x_position > 2855 and global_player_x_position < 3170:
            player_y_position += 1
            player_ground_position = 560

        if global_player_x_position <= 3170 and global_player_x_position < 3270:
            player_ground_position = 382

        if global_player_x_position > 3270 and global_player_x_position < 3625:
            player_y_position += 1
            player_ground_position = 560

        if global_player_x_position <= 3625 and global_player_x_position < 3715:
            player_ground_position = 347

        if global_player_x_position > 3715 and global_player_x_position < 4025:
            player_y_position += 1
            player_ground_position = 560

        if global_player_x_position <= 4025 and global_player_x_position < 4115:
            player_ground_position = 347

        if global_player_x_position > 4115 and global_player_x_position < 4480:
            player_y_position += 1
            player_ground_position = 560

        if global_player_x_position <= 4480 and global_player_x_position < 4570:
            player_ground_position = 382

        if global_player_x_position > 4570 and global_player_x_position < 4890:
            player_y_position += 1
            player_ground_position = 560

        if global_player_x_position <= 4890 and global_player_x_position < 4970:
            player_ground_position = 347

        if global_player_x_position > 4970 and global_player_x_position < 5345:
            player_y_position += 1
            player_ground_position = 560

        if global_player_x_position <= 5345 and global_player_x_position < 5425:
            player_ground_position = 347

        if global_player_x_position > 5425 and global_player_x_position < 5740:
            player_y_position += 1
            player_ground_position = 560

        if global_player_x_position <= 5740 and global_player_x_position < 5830 :
            player_ground_position = 382

        if global_player_x_position > 5830 and global_player_x_position < 6195:
            player_y_position += 1
            player_ground_position = 560

        if global_player_x_position <= 6195 and global_player_x_position < 6285:
            player_ground_position = 347

        if global_player_x_position > 6285 and global_player_x_position < 6595:
            player_y_position += 1
            player_ground_position = 560

        if global_player_x_position <= 6595 and global_player_x_position < 6685:
            player_ground_position = 347

        if global_player_x_position > 6685 and global_player_x_position < 7060:
            player_y_position += 1
            player_ground_position = 560

        if global_player_x_position <= 7060 and global_player_x_position < 7140 :
            player_ground_position = 382

        if global_player_x_position > 7140 and global_player_x_position < 7455:
            player_y_position += 1
            player_ground_position = 560

        if global_player_x_position <= 7455 and global_player_x_position < 8820:
            player_ground_position = 347

        #Determines if player has finished the game, and if true calls game over function
        if global_player_x_position >= 8200:
