...
def play_level_1():
    ...
    player_y_position = 432
    player_ground_position = 432
    ground_height = 432
    ...
    badguy_list.add(badguy1, badguy2)
    ...
    while active:
        ...
        badguy1x = camera_offset_x + bxcounter + 1356
        badguy2x = camera_offset_x + bxcounter + 3092
        ...
        draw_terrain(300 + camera_offset_x, 125, 0, 0, "Images/Terrain/Level Entrance/Level 1/Level 1.png", 250, 250)
        ...
        draw_terrain(1356 + camera_offset_x, 473, 0, 0, "Images/Terrain/Ground/Left Grass.png", 128, 128)
        draw_terrain(1356 + camera_offset_x, 601, 0, 2, "Images/Terrain/Ground/Left Middle Ground.png", 128, 128)
        draw_terrain(1484 + camera_offset_x, 473, 9, 0, "Images/Terrain/Ground/Middle Grass.png", 128, 128)
        draw_terrain(1484 + camera_offset_x, 601, 9, 5, "Images/Terrain/Ground/Middle Ground.png", 128, 128)
        draw_terrain(2764 + camera_offset_x, 473, 0, 2, "Images/Terrain/Ground/Right Grass.png", 128, 128)
        draw_terrain(2764 + camera_offset_x, 601, 0, 2, "Images/Terrain/Ground/Middle Right Ground.png", 128, 128)

        spikes(1, 1500 + camera_offset_x, 345, pch3, spike_list).draw(win)
        spikes(1, 2000 + camera_offset_x, 345, pch3, spike_list).draw(win)

        spikes(1, 2100 + camera_offset_x, 345, pch3, spike_list).draw(win)

        draw_terrain(3092 + camera_offset_x, 473, 0, 0, "Images/Terrain/Ground/Left Grass.png", 128, 128)
        draw_terrain(3092 + camera_offset_x, 601, 0, 2, "Images/Terrain/Ground/Left Middle Ground.png", 128, 128)
        draw_terrain(3220 + camera_offset_x, 473, 9, 0, "Images/Terrain/Ground/Middle Grass.png", 128, 128)
        draw_terrain(3220 + camera_offset_x, 601, 9, 5, "Images/Terrain/Ground/Middle Ground.png", 128, 128)
        draw_terrain(4500 + camera_offset_x, 473, 0, 2, "Images/Terrain/Ground/Right Grass.png", 128, 128)
        draw_terrain(4500 + camera_offset_x, 601, 0, 2, "Images/Terrain/Ground/Middle Right Ground.png", 128, 128)

        spikes(1, 3200 + camera_offset_x, 345, pch3, spike_list).draw(win)
        spikes(1, 4100 + camera_offset_x, 345, pch3, spike_list).draw(win)

        draw_terrain(4350 + camera_offset_x, 345, 0, 0, "Images/Terrain/Misc/Finish_Flag.png", 128, 128)

        draw_terrain(-128 + camera_offset_x, 560, 0, 0, "Images/Terrain/Ground/Left Grass.png", 128, 128)
        draw_terrain(-128 + camera_offset_x, 624, 0, 2, "Images/Terrain/Ground/Left Middle Ground.png", 128, 128)
        draw_terrain(0 + camera_offset_x, 560, 7, 0, "Images/Terrain/Ground/Middle Grass.png", 128, 128)
        draw_terrain(0 + camera_offset_x, 624, 7, 5, "Images/Terrain/Ground/Middle Ground.png", 128, 128)

        draw_terrain(900 + camera_offset_x, 495, 0, 0, "Images/Terrain/Ground/Left Grass.png", 128, 128)
        draw_terrain(900 + camera_offset_x, 623, 0, 3, "Images/Terrain/Ground/Left Middle Ground.png", 128, 128)
        draw_terrain(1028 + camera_offset_x, 495, 0, 0, "Images/Terrain/Ground/Right Grass.png", 128, 128)
        draw_terrain(1028 + camera_offset_x, 623, 0, 3, "Images/Terrain/Ground/Middle Right Ground.png", 128, 128)
        ...
        if global_player_x_position > 1095 and global_player_x_position < 1310:
            player_y_position += 1
            player_ground_position = 560

        if global_player_x_position >= 1310 and global_player_x_position <= 2825:
            player_ground_position = 345

        # First Water
        if global_player_x_position > 2825 and global_player_x_position < 3075:
            player_y_position += 1
            player_ground_position = 560

        if global_player_x_position >= 3075 and global_player_x_position <= 4565:
            player_ground_position = 345

        if global_player_x_position < 810 and not player_ground_position == 435:
            player_ground_position = 435

        if global_player_x_position >= 810 and not global_player_x_position < -250 and move[2] == 1:
            player_ground_position = 345
          
            if global_player_x_position >= 810 and global_player_x_position <= 1095 and player_y_position > 367:
                player_y_position = 367

        #Determines if player has finished the game, and if true calls game over function
        if global_player_x_position >= 4350:
